...
def b2b():
    ...
    find_string = commun.find_string()
    for value in find_string:
        urn = "/market/?f_keyword=" + value + "&searching=1&company_type=2&price_currency=0&date=1&trade=all#search-result"
        url = uri + urn
