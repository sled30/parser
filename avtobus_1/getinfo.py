...
#    status = None
def find_string():
    find_string = ('автобусы',                         #'автобусы',
                   'транспорное',                   # 'перевозка'
                   'транспорное',       #'транспорное'
                   'транспорные',                       #'транспорные'
                   'автобусов',         #'автобусов'
                   'микроавтобусы',                 # 'микроавтобусы',
                   'транспортное сопровождение',                #транспортное сопровождение
                   'транспортное обслуживание',             #'транспортное обслуживание'
                   'транспорных услуг',    #транспорных услуг
                   'транспортного средства',  #транспортного средства
                   'микроавтобусов',            #микроавтобусов
                   'транспортировка',           #'транспортировка',
                   'перевозка сотрудников',         #перевозка сотрудников
                   'регулярные перевозки',              #регулярные перевозки
                   'транспортных средств',          #'транспортных средств
                   'доставка сотрудников',  #'доставка сотрудников',
                   'детей',     #'детей',
                   'оферта')            #оферта
